...
## The Output: 
Shown are the transformations to the image done by each of the 16 channels in Layer1. Red represents the most negative output, and Blue represents the most positive output.  
