...
Shown here are the transformations done to the image by each of the 16 channels in Layer1. Yellow represents degree of negative output, and Blue represents the positive output.  
